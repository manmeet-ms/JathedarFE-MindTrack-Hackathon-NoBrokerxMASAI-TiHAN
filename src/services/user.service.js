...
export const updateHourlyCheckinSrv = (id, data) =>
  api.put(`/users/hourly-checkins/${id}`, data, { withCredentials: true });

export const deleteHourlyCheckinSrv = (id) =>
  api.delete(`/users/hourly-checkins/${id}`, { withCredentials: true });
